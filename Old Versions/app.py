    ...
    for site in SITES:
        ...
        for f in all_site_files[site]:
            ...
            with c1:
                ...
                st.checkbox("", value=val, key=chk_key, label_visibility="collapsed")
            with c2:
        ...
        if rewritten_items:
            ...
            for item in rewritten_items:
                ...
                with c_check:
                    ...
                    p_state = st.checkbox("", value=item['is_posted'], key=p_key, label_visibility="collapsed")
